     ...
     render(){
         ...
         return(
             <div className='masterdiv'>
                 <AppBar className='colorbar1'
                    title="Parents Connect"
                    iconElementRight={<img src={b} alt='userpic' style={{borderRadius:'40px', width:'40px', height:'40px'}} />}
                />
        ...
        >
                <Step>
                    ...
                    <p style={{margin:'auto', fontWeight:'bold', fontSize:'18px', color:'white'}}>Present Books Taken</p>
                    </StepButton>
                    <StepContent>
                    <li>
                        <ol>Balarama</ol>
                ...
                <Step>
                    ...
                    <p style={{margin:'auto', fontWeight:'bold', fontSize:'18px', color:'white'}}>Book's History</p>
                    </StepButton>
                    <StepContent>
                    <p>No history</p>
                ...
                <Step>
                    ...
                    <p style={{margin:'auto', fontWeight:'bold', fontSize:'18px', color:'white'}}>Book a book</p>
                    </StepButton>
                    <StepContent>
                    <p>
